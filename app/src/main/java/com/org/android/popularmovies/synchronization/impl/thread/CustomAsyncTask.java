 ...
 * <p>
 * There are 3 changes in this copy of CustomAsyncTask:
 ...
 * *************************************
 * <p>
 * <p>CustomAsyncTask enables proper and easy use of the UI thread. This class allows to
 * perform background operations and publish results on the UI thread without
 * having to manipulate threads and/or handlers.</p>
 * <p>
 * <p>CustomAsyncTask is designed to be a helper class around {@link Thread} and {@link android.os.Handler}
 ...
 * <p>
 * <h2>Usage</h2>
 * <p>CustomAsyncTask must be subclassed to be used. The subclass will override at least
 * one method ({@link #doInBackground}), and most often will override a
 * second one ({@link #onPostExecute}.)</p>
 * <p>
 * <p>Here is an example of subclassing:</p>
 * <pre class="prettyprint">
 * private class DownloadFilesTask extends CustomAsyncTask&lt;URL, Integer, Long&gt; {
 ...
 * </pre>
 * <p>
 * <h2>CustomAsyncTask's generic types</h2>
 ...
 * <pre>
 * private class MyTask extends CustomAsyncTask&lt;Void, Void, Void&gt; { ... }
 * </pre>
 * <p>
 * <h2>The 4 steps</h2>
 ...
 * work properly:</p>
 * <ul>
 * <li>The CustomAsyncTask class must be loaded on the UI thread. This is done
 ...
 * <p>CustomAsyncTask guarantees that all callback calls are synchronized in such a way that the following
...
public abstract class CustomAsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = ApiVersion.hasHoneycomb() ? new SerialExecutor() :
     ...
     * CustomAsyncTask, however you can also use your own {@link java.util.concurrent.Executor} for custom
     * behavior.
     * <p>
     ...
     * @see #execute(Object[])
     */
    public final CustomAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                           Params... params) {
     ...
     * canceled.
     *
     * @param values The progress values to updateFailed the UI with.
